...
public class NoPatienceDialog extends JDialog implements ActionListener, ItemListener{
    JButton buttonOK;
    ...
    public NoPatienceDialog() {
        Dimension size;
        size=new Dimension(400,300);
        
        this.setTitle("No Patience");
        ...
        InfoLabel=new JLabel("                                 "
                + "Cashier has lost their patience!");
